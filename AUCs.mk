AUCs
****
As a Fire Marshal, you are expected to uphold the standards and reputation of the FDNY. As such, it is important for you to know that the level of alcohol that elicits a positive test result for Department members is ____ blood alcohol concentration (“BAC”).
-- .05
.08
.1
.2
BAC is the amount of alcohol in your blood as determined by a urine, blood or saliva test
AUC 202 3.3

EVERY BFI MEMBER SELECTED FOR DRUG TESTING SHALL BE TESTED ON THE DATE AND AT THE TIME DESIGNATED BY THE FDNY, PURSUANT TO ESTABLISHED PROCEDURES. NO FIRE MARSHAL\'S REQUEST TO BE EXCUSED OR RESCHEDULED (INCLUDING EMERGENCY LEAVES), SHALL BE GRANTED WITHOUT THE APPROVAL OF THE?
Supervising Fire Marshal
Chief of Operations
Director of BITS
-- Chief Fire Marshal
NO BFI MEMBER’S REQUEST TO BE EXCUSED OR RESCHEDULED (INCLUDING EMERGENCY LEAVES), SHALL BE GRANTED WITHOUT THE APPROVAL OF THE CHIEF FIRE MARSHAL, EXCEPT FOR THE CHIEF FIRE MARSHAL.
AUC 202 ADD 1 4.7.1
...
WHICH MEMBER OF THE DEPARTMENT FOLLOWED PROPER PROCEDURES FOR OPERATING AT A FIRE DESIGNATED A "CRIME SCENE?"
FF Smith washed her hands in the bathroom sink of the fire apartment after receiving a laceration to her left wrist while overhauling
Fire Marshal Jones adjusted the volume on the television in the apartment he was investigating as he had to confer with the Supervising Fire Marshal via cell phone
-- Lt. Jackson ordered his members not to untie a deceased teenage girl found bound to a chair with zip ties in the fire apartment
While taking up hoseline from the fire area, FF Stevens covered a 10-45 code 1 victim with a blanket because it was making the probationary firefighter queasy
A) DO NOT WASH HANDS IN SINKS OR USE TOILET FACILITIES
B) DO NOT ADJUST RADIO OR TELEVISION, OR USE TELEPHONE IN CRIME SCENE AREA.
D) REFRAIN FROM COVERING ANY CORPSE EXCEPT IN PUBLIC VIEW.
AUC 317 5.9-5.12
